    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, var(--color-background, hsl(var(--background))), transparent)",
          }}
        />
        <div
          ...
          style={{
            background:
              "linear-gradient(to top, var(--color-background, hsl(var(--background))), transparent)",
          }}
        />
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to top, oklch(0.12 0.008 60 / 0.85) 0%, oklch(0.12 0.008 60 / 0.4) 60%, transparent 100%)",
