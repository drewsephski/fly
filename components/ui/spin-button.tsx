        ...
        <div className={styles.wrap}>
          ...
          <div className={styles.content}>
            <span className={`${styles.char} ${styles.state1}`}>
              <span data-label="O" style={{ "--i": 1 } as React.CSSProperties}>
                O
              </span>
              <span data-label="p" style={{ "--i": 2 } as React.CSSProperties}>
                p
              </span>
              <span data-label="e" style={{ "--i": 3 } as React.CSSProperties}>
                e
              </span>
              <span data-label="n" style={{ "--i": 3 } as React.CSSProperties}>
                n
              </span>
              <span data-label=" " style={{ "--i": 6 } as React.CSSProperties}>
                {" "}
              </span>
              <span data-label="C" style={{ "--i": 7 } as React.CSSProperties}>
                C
              </span>
              <span data-label="h" style={{ "--i": 8 } as React.CSSProperties}>
                h
              </span>
              <span data-label="a" style={{ "--i": 9 } as React.CSSProperties}>
                a
              </span>
              <span data-label="t" style={{ "--i": 10 } as React.CSSProperties}>
                t
              </span>
            </span>
            ...
            <span className={`${styles.char} ${styles.state2}`}>
              <span data-label="C" style={{ "--i": 1 } as React.CSSProperties}>
                C
              </span>
              <span data-label="l" style={{ "--i": 2 } as React.CSSProperties}>
                l
              </span>
              <span data-label="o" style={{ "--i": 3 } as React.CSSProperties}>
                o
              </span>
              <span data-label="s" style={{ "--i": 4 } as React.CSSProperties}>
                s
              </span>
              <span data-label="e" style={{ "--i": 4 } as React.CSSProperties}>
                e
              </span>
              <span data-label="C" style={{ "--i": 5 } as React.CSSProperties}>
                C
              </span>
              <span data-label="h" style={{ "--i": 6 } as React.CSSProperties}>
                h
              </span>
              <span data-label="a" style={{ "--i": 6 } as React.CSSProperties}>
                a
              </span>
              <span data-label="t" style={{ "--i": 6 } as React.CSSProperties}>
                t
              </span>
            </span>
          </div>
