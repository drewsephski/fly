      ...
      <div className="space-y-4">
        <div className="space-y-3">
          ...
          <p className="text-sm text-muted-foreground">
            We&apos;re launching Component Sync, a new way to manage, version,
            and update all your shadcn components across projects with a single
            click.
          </p>
        </div>
        <div className="space-y-3">
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent className="text-muted-foreground">
              ...
              <div className="mt-4 flex flex-wrap items-center gap-4">
                <div className="rounded-[6px] bg-primary/10 px-3 py-1 text-xs leading-4.5 font-medium text-destructive">
                  /v1/components/sync
                </div>
                <div className="rounded-[6px] bg-primary/10 px-3 py-1 text-xs leading-4.5 font-medium text-destructive">
                  /v1/components/pull
