      ...
      <div className="space-y-4">
        <div className="space-y-3">
          ...
          <p className="text-sm text-muted-foreground">
            We&apos;ve completely redesigned the theme system for Design Tokens
            2.0. Tokens are now hierarchical, semantic, and fully type-safe —
        ...
        />
        <p className="text-sm text-muted-foreground">
          Design Tokens 2.0 introduces a complete overhaul of how themes are
          managed within shadcnstudio. With this update, design tokens are now
          hierarchical and semantic, offering greater flexibility and
          scalability for your design system.
        </p>
        <p className="text-sm text-muted-foreground">
          The new system supports automatic dark/light theme pairing, making it
          easier than ever to maintain consistent visuals across all
          environments. Tokens for colors, spacing, typography, and more are now
          fully type-safe and easily customizable, ensuring that your design
          system can grow alongside your projects.{" "}
        </p>
        <Accordion
          type="multiple"
        ...
        >
          <AccordionItem value="item-1">
            ...
            <AccordionContent className="text-muted-foreground">
              <ul className="list-inside list-disc space-y-3 text-sm text-muted-foreground">
                <li>
                  Complete token overhaul unified color, spacing & typography
                  system.
                </li>
                <li>
                ...
                <li>
                  Preview share links generate temporary links to share progress
                  with your team
                </li>
              </ul>
            </AccordionContent>
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent className="text-muted-foreground">
              <ul className="list-inside list-disc space-y-3 text-sm text-muted-foreground">
                <li>
                  Smarter token fallback logic for consistent theming across
                  components
                </li>
                <li>
                  Improved OKLCH color handling for better contrast &
                  accessibility
                </li>
                <li>
                ...
                <li>
                  Better error handling during build failures with clearer
                  actions
                </li>
                <li>
                  Updated environment variable manager for easier key/value
                  edits
                </li>
              </ul>
            </AccordionContent>
